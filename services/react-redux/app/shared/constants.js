...
export const ROLES = [
  { graph_type: 'SubscriptionChart', props: { title: 'Subscriptions Hourly' }, roles: ['tech', 'management'] },
  ...
  { graph_type: 'RenewalChart', props: { title: 'Renewals Hourly' }, roles: ['tech', 'management'] },
